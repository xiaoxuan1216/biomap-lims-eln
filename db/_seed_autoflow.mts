/** v3 seed：
 * 1) 重组抗体演示流程（134264 zh / 134265 en）的分子克隆节点 → 全自动克隆岛模板（a_auto_cloning）
 * 2) 其分子克隆子流程（134271 / 134272）内容整体替换为 25 节点机械臂串联版，并设置演示进度
...
await rebuildSubflow(134271, 134264, "zh");
await rebuildSubflow(134272, 134265, "en");

/* ── 实验任务 ↔ 业务流演示关联（按名称匹配，中英双语库） ── */
const links: [string, string][] = [
  // [workflow 名, experiment 名]
  ["CD19-CAR-4G 慢病毒载体构建", "CAR 载体测序验证"],
  ...
  ["CD19-CAR-4G Lentiviral Vector Construction", "CAR Vector Sequencing Verification"],
